...
exports.addAllNew = function (req, res) {
  var nameList = req.body.userlist;

  for(var i in nameList) {

    var preUser = nameList[i];
    if(preUser === "" || typeof preUser === 'undefined') return res.json("error");

    var newUser = new User();
    newUser.name = preUser.name;
    newUser.email = preUser.email;
    newUser.avatar = makeAvatarUrl(newUser.email);
    newUser.provider = "local";
